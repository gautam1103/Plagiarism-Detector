...
st.title("AI Text Analysis with GPT Shield")
text_area = st.text_area("Paste your text here", "")
    ...
    if st.button("Start Analysis"):
        ...
        with col2:
            ...
            if perplexity > 30000 and burstiness_score < 0.2:
                st.error("Analysis Conclusion: AI-generated text detected")
            else:
                st.success("Analysis Conclusion: Likely not AI-generated text")
            
            st.warning("Disclaimer: AI plagiarism detection tools can help identify potential instances of plagiarism. However, results may include false positives or false negatives. It is advisable to use such tools alongside human judgment and manual verification for accurate detection.")
